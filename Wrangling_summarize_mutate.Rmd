...
Films produced in 1893 are the oldest on this list. Movies are typically 82 minutes and 34 seconds long. Despite the fact that the standard deviation is 44 minutes and approximately 35 seconds.
...
The previous query that used per_low to obtain the low movie ratings is the source of the poor rating. After that, we'll filter to look at per_low and votes higher than five, which will provide us with a list of all the films we believe to have low ratings and votes higher than five. We must now determine the total number of films with ratings higher than five that are deemed to have a poor rating.
...
# Side Questions
With more than five votes, 4753 films have a significant percentage of bad ratings.
